...
type ActorVersion int32

const (
	// Dapr API v2
	// Uses 0 for backwards-compatibility
	ActorVersion_ACTORS_V1 ActorVersion = 0
	// Dapr Actors v2
	ActorVersion_ACTORS_V2 ActorVersion = 1
)

// Enum value maps for ActorVersion.
var (
	ActorVersion_name = map[int32]string{
		0: "ACTORS_V1",
		1: "ACTORS_V2",
	}
	ActorVersion_value = map[string]int32{
		"ACTORS_V1": 0,
		"ACTORS_V2": 1,
	}
)

func (x ActorVersion) Enum() *ActorVersion {
	p := new(ActorVersion)
	*p = x
	return p
}

func (x ActorVersion) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ActorVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_dapr_proto_internals_v1_apiversion_proto_enumTypes[1].Descriptor()
}

func (ActorVersion) Type() protoreflect.EnumType {
	return &file_dapr_proto_internals_v1_apiversion_proto_enumTypes[1]
}

func (x ActorVersion) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ActorVersion.Descriptor instead.
func (ActorVersion) EnumDescriptor() ([]byte, []int) {
	return file_dapr_proto_internals_v1_apiversion_proto_rawDescGZIP(), []int{1}
}
...
var file_dapr_proto_internals_v1_apiversion_proto_rawDesc = []byte{
	...
	0x02, 0x56, 0x31, 0x10, 0x01, 0x2a, 0x2c, 0x0a, 0x0c, 0x41, 0x63, 0x74, 0x6f, 0x72, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x43, 0x54, 0x4f, 0x52, 0x53, 0x5f,
	0x56, 0x31, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x43, 0x54, 0x4f, 0x52, 0x53, 0x5f, 0x56,
	0x32, 0x10, 0x01, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_dapr_proto_internals_v1_apiversion_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dapr_proto_internals_v1_apiversion_proto_goTypes = []interface{}{
	(APIVersion)(0),   // 0: dapr.proto.internals.v1.APIVersion
	(ActorVersion)(0), // 1: dapr.proto.internals.v1.ActorVersion
}
