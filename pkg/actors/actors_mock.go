...
type (
	...
	// Expose LookupActorRequest for mocking
	LookupActorRequest = internal.LookupActorRequest

	// Expose LookupActorResponse for mocking
	LookupActorResponse = internal.LookupActorResponse
)
